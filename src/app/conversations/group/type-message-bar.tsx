...
import { CustomTooltip, CircularProgress } from "@/components/materials"
import {
  FileVideo,
  Mic,
  Paperclip,
...
import { ExpressionPicker, MessageTextField } from "./message-textfield"
...
export const TypeMessageBar = memo(
  ({ groupChat, replyMessage, setReplyMessage }: TTypeMessageBarProps) => {
    ...
    function renderReplyPreview(msg: TStateMessage) {
      ...
      if (msg.isDeleted) {
        return <span className="text-sm text-gray-400">This message has been deleted</span>
      }
