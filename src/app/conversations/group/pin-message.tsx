...
export const renderMessageContent = (message: TStateMessage) => {
  ...
  // Image message - display thumbnail
  ...
  // Video message - display thumbnail
  ...
  // Document message - display thumbnail
  ...
  // Audio message - display thumbnail
  ...
  // Sticker message - display thumbnail
  ...
  if (type === EMessageTypes.TEXT && content) {
    ...
    // Regular text message - display text content normally
    return (
      <div className="flex-1 min-w-0">
        <div
  ...
  // Fallback - only display when no type matches
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="bg-regular-dark-gray-cl rounded-lg shadow-lg max-w-md w-full p-0 relative border border-gray-700">
        ...
        <ul className="divide-y divide-gray-700">
          {pinnedMessages.length === 0 ? (
            <li className="p-4 text-gray-400 text-sm">No messages have been pinned yet.</li>
          ) : (
