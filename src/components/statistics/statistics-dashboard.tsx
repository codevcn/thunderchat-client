            ...
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
               <div className="flex items-center">
                  ...
                  <div className="ml-4">
                     ...
                     <p className="text-2xl font-bold text-blue-900">{safeOverall.totalMessages.toLocaleString()}</p>
                  </div>
               </div>
            </div>
            ...
            <div className="bg-green-50 p-6 rounded-lg border border-green-200">
               <div className="flex items-center">
                  ...
                  <div className="ml-4">
                     ...
                     <p className="text-2xl font-bold text-green-900">{safeOverall.totalUsers.toLocaleString()}</p>
                  </div>
               </div>
            </div>
            ...
            <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
               <div className="flex items-center">
                  ...
                  <div className="ml-4">
                     ...
                     <p className="text-2xl font-bold text-purple-900">{safeOverall.totalFiles.toLocaleString()}</p>
                  </div>
               </div>
            </div>
            ...
            <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
               <div className="flex items-center">
                  ...
                  <div className="ml-4">
                     ...
                     <p className="text-2xl font-bold text-orange-900">{safeOverall.totalChats.toLocaleString()}</p>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-50 p-6 rounded-lg border">
               ...
               <p className="text-3xl font-bold text-blue-600">
                  {safeOverall.totalChats > 0 ? (safeOverall.totalMessages / safeOverall.totalChats).toFixed(1) : "--"}
               </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg border">
               ...
               <p className="text-3xl font-bold text-green-600">
                  {safeOverall.totalChats > 0 ? (safeOverall.totalFiles / safeOverall.totalChats).toFixed(1) : "--"}
               </p>
            </div>
         </div>
