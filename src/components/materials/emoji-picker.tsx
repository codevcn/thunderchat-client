    ...
    <div ref={pickerRef} className="overflow-hidden w-full h-inside-expression-picker">
      ...
      <div className="flex overflow-x-auto p-2 gap-2">
        <EmojiTab
          icon={
            <img
              alt="beaming-face-with-smiling-eyes_1f601.webp"
              className="w-[22px] h-[22px]"
              src="/emojis/smiley-people/beaming-face-with-smiling-eyes_1f601.webp"
            ></img>
          }
          label="Smileys"
        ...
        <EmojiTab
          icon={
            <img
              alt="fork-and-knife_1f374.webp"
              className="w-[22px] h-[22px]"
              src="/emojis/food-drink/fork-and-knife_1f374.webp"
            />
          }
          label="Food"
        ...
        <EmojiTab
          icon={
            <img
              alt="baseball_26be.webp"
              className="w-[22px] h-[22px]"
              src="/emojis/activity/baseball_26be.webp"
            />
          }
          label="Activity"
        ...
        <EmojiTab
          icon={
            <img
              alt="castle_1f3f0.webp"
              className="w-[22px] h-[22px]"
              src="/emojis/travel-places/castle_1f3f0.webp"
            />
          }
          label="Travel"
