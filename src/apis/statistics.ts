...
export const getMonthlyStatistics = async (params: TStatisticsParams): Promise<TMonthlyStatistics[]> => {
   try {
...
export const getOverallStatistics = async (params: TStatisticsParams): Promise<TOverallStatistics> => {
   try {
...
export const getUserStatistics = async (params: TUserStatisticsParams): Promise<TUserStatistics> => {
   try {
