...
export const ReportModal = ({ isOpen, onClose, user }: TReportModalProps) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-regular-black-cl rounded-lg w-full max-w-lg mx-4 max-h-[90vh] flex flex-col border-2 border-regular-white-cl transition-all duration-300 ease-out ${
