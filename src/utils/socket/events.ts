...
export enum ESocketEvents {
  ...
  call_request = "call_voice:request",
  call_request_ack = "call_voice:request_ack",
  call_accept = "call_voice:accept",
  call_reject = "call_voice:reject",
  call_cancel = "call_voice:cancel",
  call_end = "call_voice:end",
  call_status = "call_voice:status",
  call_offer = "call_voice:offer",
  call_answer = "call_voice:answer",
  call_ice = "call_voice:ice",
}
